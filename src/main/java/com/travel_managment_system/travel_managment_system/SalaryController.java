...
public class SalaryController implements  Loadfxml,Initializable {
    ...
    public void DisplayMonthlyTrips() throws FileNotFoundException {
        ...
        numOfMonthlyTrips.setText("Your trip count this month is " +Integer.toString(monthlyTrips.size())+", scroll down to view your salary.");
    ...
    public VBox createVBox(Trip trip) throws FileNotFoundException {
        ...
        Label tripID= new Label("Trip id: " + Integer.toString(trip.getTrip_id()));
        Label tripPayment= new Label (Double.toString(trip.getPayment())+"EGP");
