    ...
    public void start(Stage stage) throws IOException {
       lodafxmlfile("hello-view.fxml");
        ...
        Trip.trips.add(new Trip("Alexandria", 1001, "Couple", LocalDate.of(2023,12,13), LocalDate.of(2023,12,18), 400, 7000, "src/main" +
                "/resources/com/travel_managment_system/travel_managment_system/Images/Alexandria.jpeg","Alexandria", "Bus"));
        Trip.trips.add(new Trip("Hurghada", 1002, "Couple",LocalDate.of(2023,5,15) ,LocalDate.of(2023,5,18), 400, 7000, "src/main/resources/com/travel_managment_system/travel_managment_system/Images/Hurghada.png","Hurghada","Bus"));
    }
